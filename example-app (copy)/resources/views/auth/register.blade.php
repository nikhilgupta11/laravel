        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form method="post" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="contact" class="form-control @error('contact') is-invalid @enderror" value="{{ old('contact') }}" placeholder="Contact">
                        <div class="input-group-append">
                            <div class="input-group-text"><span class="fas fa-user"></span></div>
                        </div>
                        @error('contact')
                    ...
                    <div class="col-8">
                        <div class="icheck-primary">
                            <input type="checkbox" id="isvarify" name="isvarify" value=true>
                            <label for="isvarify">
                                Verify:
                            </label>
                        </div>

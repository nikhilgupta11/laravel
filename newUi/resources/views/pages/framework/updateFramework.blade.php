...
<div class="container mt-12">
    <form action="{{ route('updateframeworkdata') }}" method="POST" class="form">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ $data->name }}" placeholder="Framework name">
            </div>
        </div>
        <br />
        <div class="col-3">
